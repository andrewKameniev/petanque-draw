...
export default {
    ...
    methods: {
        ...mapActions(useMainStore, ['removeTournament', 'setPlayOff', 'setCadrage', 'addBTournament', 'finishTournament', 'showMessage', 'addTeamToStore', 'saveP', 'changeTournamentName', 'syncToFirebase', 'savePreferences']),
        startEditName() {
