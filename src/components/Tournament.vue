  ...
  <div>
      <div class="text-center is-size-3">
        ...
        <div class="content tabs-content" v-if="activeTab === 'Teams'">
            ...
            <TeamsList v-if="tournament.teams.length"/>
        ...
        <Games v-if="activeTab === 'Games'"  :teamsList="rankingTeams" :activeRound="activeRound"
            @openResults="activeTab = 'Ranking'"/>
        <Results v-if="activeTab === 'Results'"/>
        <div class="content tabs-content" v-if="activeTab === 'Ranking'">
        <Ranking :rankingTeams="rankingTeams" :activeRound="activeRound"/>
...
export default {
    ...
    methods: {
        ...mapMutations(['startRound', 'removeTournament', 'setPlayOff', 'addBTournament']),
