<template>
    <div class="elimination-round">
        ...
        <div v-if="!eliminationRound" class="elimination-round__setup">
            ...
            <button class="elimination-round__btn" @click="startElimination" :disabled="eliminationTeams.length < 2">
        ...
        <div v-else class="elimination-round__games">
            <div v-for="(game, index) in eliminationRound.games" :key="index" class="elimination-round__game">
                ...
                <div class="elimination-round__scores">
                    <input type="number" min="0" class="elimination-round__score"
            ...
            <button v-if="allScoresFilled && !eliminationRound.completed"
...
export default {
    ...
    computed: {
        ...
        allScoresFilled() {
            ...
            return this.eliminationRound.games.every(g =>
                g.team_1_score !== null && g.team_1_score !== '' &&
                g.team_2_score !== null && g.team_2_score !== ''
            );
        }
    },
    methods: {
        ...mapActions(useMainStore, ['setGroupBEliminationRound', 'completeGroupBElimination', 'syncToFirebase']),
        ...
        startElimination() {
            ...
            this.setGroupBEliminationRound({
                games,
        ...
        completeElimination() {
            this.completeGroupBElimination();
            this.$emit('completed');
        },
        onScoreChange() {
            this.syncToFirebase();
