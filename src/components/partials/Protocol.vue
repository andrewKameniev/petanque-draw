    ...
    <div class="container protocol-container">
        <div class="protocol-gate" v-if="!skipGate && password !== 499">
            <div class="protocol-gate__card">
                ...
                <p class="protocol-gate__desc">
                    Ви отримуєте на 80% готовий протокол. Треба дописати тільки тренерів команд і трохи відформатувати
                    текстовий документ.
                </p>
                <div class="protocol-gate__payment">
                    ...
                    <button
                        class="protocol-gate__copy"
                        @click="copyCard"
                        :title="cardCopied ? 'Скопійовано!' : 'Скопіювати'"
                    >
        ...
        <div v-else>
            <div class="protocol-warning">
                ...
                <span
                    >Протокол не є гарантовано вірним, може бути некоректна чи не вся інформація на порталі, може бути
                    специфічний регламент, може не бути всіх даних по гравцям. Перевіряйте вручну, будь ласка!</span
                >
            </div>
                    ...
                    <table v-if="participantChunks.length" class="table is-bordered">
                        ...
                        <tbody v-for="(team, index) in participantChunks[0]" :key="index" class="team-group">
                            <tr>
                                ...
                                <td contenteditable="plaintext-only">
                                    {{
                                        team.players?.length === 1 && team.players[0].sport_title === 'candidate'
                                            ? 'КМСУ'
                                            : ''
                                    }}
                                </td>
