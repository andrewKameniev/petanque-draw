                    ...
                    <template v-for="(team, index) in rankingTeams" :key="index">
                        <tr>
                            ...
                            <td class="has-text-weight-bold" :colspan="team.players.length > 1 ? 2 : 1" contenteditable="true">
                                ...
                                <span v-else>{{ team.players[0].surname + ' ' + team.players[0].name + ' ' + (team.players[0].second_name ? team.players[0].second_name : getPlayerThirdName(team.players[0].surname, team.players[0].name)) }}</span>
                            </td>
