      ...
      <div v-if="(isForProtocol && !onlyPlayOff) || !isForProtocol">
                  ...
                  <tr v-for="(game, i) in round" :key="i" :class="{ 'search-highlight': isGameHighlighted(game) }">
                    ...
                    <td v-if="hasGroupsColumn" class="group-cell-desktop">
                      <template v-if="game.group != null"
                        ><small>{{ $t('common.group') }}</small> {{ groupsNames[game.group] }}</template
                      >
                    </td>
                    <td
        ...
        >
          ...
          <template v-if="cardView && !isForProtocol">
            ...
            <template
              v-if="
                tournament.playOffBracket.thirdPlace && Object.keys(tournament.playOffBracket.thirdPlace).length !== 0
              "
            >
              ...
              <template v-if="stageHasContent(stage) && stage.stageLabel !== 'cadrage' && stage.stageLabel !== 1">
                ...
                <div v-for="(game, i) in stage.teams" :key="'s' + index + 'g' + i" class="playoff-game">
                  <span
                    ...
                    :class="{
                      'has-text-weight-bold': !isForProtocol && Number(game.team_1_score) > Number(game.team_2_score),
                    }"
                  ...
                  <span
                    class="playoff-team"
                    :class="{
                      'has-text-weight-bold': !isForProtocol && Number(game.team_2_score) > Number(game.team_1_score),
                    }"
              ...
              <tbody>
                ...
                >
                  <td
                    class="has-text-right"
                    :class="{
                      'has-text-weight-bold': !isForProtocol && game.team_1_score > game.team_2_score,
                    }"
                  >
                  ...
                  <td
                    :class="{
                      'has-text-weight-bold': !isForProtocol && game.team_2_score > game.team_1_score,
                    }"
                  >
