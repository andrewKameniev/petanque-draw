          ...
          >
            <span class="team-card__stat-badge"
              ...
              <strong
                >{{
                  Math.round(
                    (commonTeamStat.all.positive / (commonTeamStat.all.positive + commonTeamStat.all.negative)) * 100,
                  )
                }}%</strong
              >
            </span>
            ...
            >
              ...
              {{
                Math.round(
                  (commonTeamStat.points.positive / (commonTeamStat.points.positive + commonTeamStat.points.negative)) *
                    100,
                )
              }}%
            </span>
            ...
            >
              ...
              {{
                Math.round(
                  (commonTeamStat.tirs.positive / (commonTeamStat.tirs.positive + commonTeamStat.tirs.negative)) * 100,
                )
              }}%
            </span>
          </div>
          ...
          <div class="team-card__player-info">
            ...
            <div class="team-card__player-details">
              ...
              <div
                ...
                v-if="system === 'simple' && teamsStat[index].all.positive + teamsStat[index].all.negative > 0"
              >
