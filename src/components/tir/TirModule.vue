<template>
  <div class="tir-module">
            ...
            <div class="tir-scoring__participant-info">
              ...
              <div class="tir-scoring__progress-meta">
                <span class="tir-scoring__progress-text"
                  >{{ getThrowsCompleted(participant) }} / {{ totalThrows }} {{ $t('tir.throws') }}</span
                >
    ...
    <div v-if="view === 'table'" class="tir-table">
      ...
      <div
        v-else-if="
          !tournament.tournamentIsFinished && !tournament.tirPlayoff && tirParticipants.length && !canTransitionToRound2
        "
        class="tir-table__actions"
      >
        <div class="tir-table__actions-row">
        ...
        >
          ...
          >
            <div class="tir-playoff__match-top">
              ...
              >
              <span
                v-else-if="match.player1 && match.player2 && (match.score1 != null || match.score2 != null)"
