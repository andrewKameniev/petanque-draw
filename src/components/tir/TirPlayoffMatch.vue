    ...
    <div class="tir-pmatch">
        ...
        <div class="tir-pmatch__legend">
            <span class="tir-pmatch__legend-item"
                ><span class="tir-pmatch__legend-dot tir-pmatch__legend-dot--carreau"></span
                >{{ $t('tir.carreau') }} (5)</span
            >
            <span class="tir-pmatch__legend-item"
                ><span class="tir-pmatch__legend-dot tir-pmatch__legend-dot--reussi"></span
                >{{ $t('tir.reussi') }} (3)</span
            >
            <span class="tir-pmatch__legend-item"
                ><span class="tir-pmatch__legend-dot tir-pmatch__legend-dot--touche"></span
                >{{ $t('tir.touche') }} (1)</span
            >
            <span class="tir-pmatch__legend-item"
                ><span class="tir-pmatch__legend-dot tir-pmatch__legend-dot--manque"></span
                >{{ $t('tir.manque') }} (0)</span
            >
        </div>
