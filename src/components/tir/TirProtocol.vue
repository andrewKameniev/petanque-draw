    ...
    <div class="container protocol-container">
        <div class="protocol-gate" v-if="password !== 499">
            <div class="protocol-gate__card">
                ...
                <p class="protocol-gate__desc">
                    Ви отримуєте на 80% готовий протокол. Треба дописати тільки тренерів та трохи відформатувати
                    текстовий документ.
                </p>
        ...
        <div v-else>
            <div class="protocol-warning">
                ...
                <span
                    >Протокол не є гарантовано вірним, може бути некоректна чи не вся інформація на порталі. Перевіряйте
                    вручну, будь ласка!</span
                >
            </div>
