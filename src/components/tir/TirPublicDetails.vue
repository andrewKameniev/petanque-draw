            ...
            <div class="tir-details__grid">
              ...
              <div v-for="distance in distances" :key="distance" class="tir-details__grid-row">
                ...
                <div
                  ...
                  :class="{
                    'tir-details__grid-cell--carreau': getScore(participant, aIdx, distance) === 'carreau',
                  }"
                >
                ...
                <div
                  class="tir-details__grid-cell"
                  :class="{
                    'tir-details__grid-cell--reussi': getScore(participant, aIdx, distance) === 'reussi',
                  }"
                >
                ...
                <div
                  class="tir-details__grid-cell"
                  :class="{
                    'tir-details__grid-cell--touche': getScore(participant, aIdx, distance) === 'touche',
                  }"
                >
                ...
                <div
                  class="tir-details__grid-cell"
                  :class="{
                    'tir-details__grid-cell--manque': getScore(participant, aIdx, distance) === 'manque',
                  }"
                >
