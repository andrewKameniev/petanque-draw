export default {
    en: {
        ...
        remote: {
            ...
            uploadLogoHint: 'Click or drag image here',
            uploading: 'Uploading...',
    ...
    ua: {
        ...
        remote: {
            ...
            tournamentLogo: 'Логотип турніру',
            uploadLogo: 'Завантажити',
            removeLogo: 'Видалити логотип',
            uploadLogoHint: 'Натисніть або перетягніть зображення сюди',
            uploading: 'Завантаження...',
            logoTooLarge: 'Зображення занадто велике (макс. 2MB)',
            logoUploadError: 'Не вдалося завантажити логотип',
            logoRemoveError: 'Не вдалося видалити логотип',
        },
        games: {
            technical: 'Технічна',
            draw: 'Жеребкувати',
