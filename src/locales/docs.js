        ...
        docs: {
            ...
            groupsSystem: {
                ...
                formation: {
                    ...
                    withRating:
                        'With rating: snake distribution (1,4,5,8 in group A; 2,3,6,7 in group B) — balanced groups',
        ...
        docs: {
            ...
            groupsSystem: {
                ...
                formation: {
                    ...
                    withRating:
                        'З рейтингом: розподіл зміїкою (1,4,5,8 в групу A; 2,3,6,7 в групу B) — збалансовані групи',
        ...
        docs: {
            ...
            supermeleSystem: {
                ...
                howItWorks: {
                    ...
                    individual: 'Joueurs individuels',
                    shuffle: 'Mélange aléatoire en doublettes/triplettes',
                    optimal: 'Calcul du mix optimal',
                    avoidRepeat: 'Évitement des répétitions',
                },
                math: {
                    title: 'Formation',
                    text: 'Mix doublettes/triplettes ajusté pour inclure tous.',
                    example: 'Ex: 11 joueurs → 4 doublettes + 1 triplette = 11',
                },
                ranking: {
                    title: 'Classement',
                    text: 'victoires > différence > points marqués > rating. Pas de Buchholz.',
                },
            },
    ...
    es: {
        docs: {
            ...
            supermeleSystem: {
                ...
                howItWorks: {
                    title: 'Cómo funciona',
                    individual: 'Jugadores individuales',
                    shuffle: 'Mezcla aleatoria en dobletes/tripletes',
                    optimal: 'Cálculo del mix óptimo',
                    avoidRepeat: 'Evita repeticiones',
                },
                math: {
                    title: 'Formación',
                    text: 'Mix ajustado para incluir a todos.',
                    example: 'Ej: 11 jugadores → 4 dobletes + 1 triplete = 11',
                },
