    ...
    en: {
        docs: {
            ...
            swissSystem: {
                ...
                intro: "Teams play a limited number of rounds with intelligent pairing. NOT a round-robin — you only play a fraction of the field.",
                rules: {
                    title: "Core Rules",
                ...
                maxRounds: {
                    ...
                    explanation: "Each round eliminates one possible future opponent. After ~N/2 rounds the algorithm can't find valid pairs.",
                    teams: "Teams",
                    rounds: "Max Rounds"
                },
                firstRound: {
            ...
            supermeleSystem: {
                ...
                intro: "Individual players register alone. Teams are randomly reformed EVERY round — a great social format.",
                howItWorks: {
                    title: "How It Works",
                    individual: "Players are individual participants (not fixed teams)",
                    shuffle: "Each round: shuffle all players into random doubles or triples",
                    optimal: "App calculates optimal doubles/triples mix",
                    avoidRepeat: "Tracks teammates to avoid repeats (best-effort)"
                },
                math: {
                    title: "Team Formation",
                    text: "For N players with preferred team size: adjust mix of doubles/triples until all players are included.",
                    example: "Example: 11 players → 4 doubles (8) + 1 triple (3) = 11"
                },
                ranking: {
                    title: "Ranking",
                    text: "wins > point difference > points scored > rating. No Buchholz — meaningless with random teams."
                }
            },
    ...
    ua: {
        docs: {
            ...
            glossary: {
                ...
                barrage: {
                    term: "Бараж",
                    short: "Кваліфікація круговим турніром у малих групах перед плей-офф"
                },
                cadrage: {
                    term: "Кадраж",
                    short: "Додатковий раунд для команд на межі між Швейцаркою та Плей-офф"
                },
                playoff: {
                    term: "Плей-офф",
            ...
            swissSystem: {
                ...
                intro: "Команди грають обмежену кількість раундів з розумною жеребкуванням. НЕ круговий турнір — ви граєте лише частину суперників.",
                rules: {
                ...
                maxRounds: {
                    ...
                    explanation: "Кожен раунд виключає одного можливого майбутнього суперника. Після ~N/2 раундів алгоритм не може знайти валідні пари.",
                    teams: "Команди",
                    rounds: "Макс. раундів"
                },
                firstRound: {
            ...
            groupsSystem: {
                ...
                after: {
                    title: "Після груп",
                    text: "Найкращі N команд з кожної групи виходять в Плей-офф або Кадраж."
                }
            },
            ...
            barrageSystem: {
                ...
                standalone: {
                    ...
                    text: "Команди розподіляються в групи, грають повний круг. Кращі з кожної групи виходять в Плей-офф."
                },
                withinSwiss: {
                    ...
                    step4: "Кращі N з кожної групи виходять в плей-офф"
                },
                qualification: {
                    title: "Кваліфікація",
                    text: "Команді потрібно 2+ перемоги в групі баражу для кваліфікації в плей-офф."
                },
                ranking: {
                    title: "Рейтинг",
            ...
            supermeleSystem: {
                ...
                intro: "Гравці реєструються індивідуально. Команди випадково перемішуються КОЖЕН раунд — чудовий соціальний формат.",
                howItWorks: {
                    title: "Як це працює",
                    individual: "Гравці — індивідуальні учасники (не фіксовані команди)",
                    shuffle: "Кожен раунд: перемішування в випадкові дублети або триплети",
                    optimal: "Додаток розраховує оптимальний мікс",
                    avoidRepeat: "Відстеження партнерів щоб уникнути повторів"
                },
                math: {
                    title: "Формування команд",
                    text: "Для N гравців з бажаним розміром: корекція міксу дублетів/триплетів поки всі гравці не включені.",
                    example: "Приклад: 11 гравців → 4 дублети (8) + 1 триплет (3) = 11"
                },
                ranking: {
                    title: "Рейтинг",
                    text: "перемоги > різниця очок > забиті очки > рейтинг. Без Бухгольца — безглуздо при змінних командах."
                }
            },
            ...
            tirSystem: {
                ...
                rounds: {
                    ...
                    text: "Необов'язковий режим: 1-й раунд для всіх, топ 4 напряму в чвертьфінал. Місця 5-16 грають 2-й раунд. Кращі 4 з R2 (за сумою) приєднуються до 4 прямих кваліфікантів. 8 гравців в плей-офф."
                },
                ranking: {
                    title: "Рейтинг",
            ...
            cadrageSystem: {
                ...
                example: {
                    title: "Приклад: 50 команд, топ-16 плей-офф",
            ...
            swissPlayoff: {
                ...
                flow: {
                    ...
                    step2: "Організатор запускає Плей-офф — топ N команд у сітку",
                    step3: "Плей-офф на виліт визначає фінальний рейтинг"
                },
                options: {
                    title: "Опції",
                    cadrage: "Додати Кадраж між Швейцаркою та Плей-офф",
                    tournamentB: "Турнір Б для команд що не пройшли"
                }
            },

            swissBarragePlayoff: {
                title: "Швейцарка + Бараж + Плей-офф",
                ...
                flow: {
                    ...
                    step3: "Переможці груп виходять в Плей-офф"
                },
                whenToUse: {
            ...
            tournamentB: {
                ...
                intro: "Коли починається плей-офф, решта команд може продовжити в новому турнірі.",
                howItWorks: {
                    title: "Як це працює",
                    step1: "Організатор вмикає Турнір Б перед запуском плей-офф",
            ...
            faqSection: {
                ...
                items: {
                    ...
                    a4: "Той самий круговий формат, але Бараж — короткий кваліфікаційний етап (3-4 команди) між Швейцаркою та Плей-офф. Групи — окрема система.",
                    ...
                    a7: "Це означає що не існує валідних пар (забагато зіграних раундів). Ви досягли математичної межі — запускайте плей-офф або завершіть турнір.",
                    q8: "Як працює посів в Плей-офф?",
    ...
    fr: {
        docs: {
            ...
            glossary: {
                ...
                swiss: { term: "Système suisse", short: "Appariement intelligent — adversaires de même niveau, sans revanche" },
            ...
            swissSystem: {
                ...
                rules: { title: "Règles", noRematch: "Une équipe ne joue JAMAIS deux fois le même adversaire", equalWins: "Après le 1er tour, les équipes avec le même nombre de victoires se rencontrent", pairing: "Dans chaque groupe : premier contre dernier", odd: "Nombre impair = Technique pour la plus faible sans bye" },
                maxRounds: { title: "Tours maximum", explanation: "Chaque tour élimine un adversaire possible. Après ~N/2 tours l'algorithme ne trouve plus de paires.", teams: "Équipes", rounds: "Tours max" },
                firstRound: { title: "Premier tour", noRating: "Sans classement : aléatoire", withRating: "Avec classement : têtes de série" },
                subsequentRounds: { title: "Tours suivants", step1: "Trier par classement", step2: "Grouper par victoires", step3: "Premier vs dernier", step4: "Si invalide : essayer suivant", step5: "Si aucun : algorithme de retour arrière", step6: "Si épuisé : erreur" },
                bye: { title: "Technique (Bye)", text: "Nombre impair : l'équipe la plus faible reçoit un forfait (13:7). Maximum un bye par tournoi." },
                calculator: { title: "Calculateur suisse", description: "Calculez le nombre optimal de tours", teamsLabel: "Nombre d'équipes", result: "Tours recommandés : {rounds} (max : {max})" }
            },
            ...
            groupsSystem: {
                ...
                formation: { title: "Formation", withRating: "Avec classement : distribution serpentin", noRating: "Sans classement : aléatoire", special: "Schéma spécial pour <33 équipes" },
                scheduling: { title: "Calendrier", text: "Méthode du cercle : position 0 fixe, les autres tournent." },
                ranking: { title: "Classement", criteria: "victoires > confrontations directes > points directs > différence", headToHead: "En cas d'égalité, seuls les résultats directs comptent." },
            ...
            barrageSystem: {
                ...
                standalone: { title: "Système autonome", text: "Équipes en groupes, round-robin complet. Les meilleurs avancent." },
                withinSwiss: { title: "Dans le suisse", step1: "Après les tours suisses, l'organisateur lance le barrage", step2: "Équipes distribuées en petits groupes (3-4)", step3: "Round-robin dans chaque groupe", step4: "Top N par groupe avance" },
            ...
            supermeleSystem: {
                ...
                intro: "Les joueurs s'inscrivent individuellement. Équipes reformées aléatoirement à chaque tour.",
                howItWorks: { title: "Comment ça marche", individual: "Joueurs individuels", shuffle: "Mélange aléatoire en doublettes/triplettes", optimal: "Calcul du mix optimal", avoidRepeat: "Évitement des répétitions" },
                math: { title: "Formation", text: "Mix doublettes/triplettes ajusté pour inclure tous.", example: "Ex: 11 joueurs → 4 doublettes + 1 triplette = 11" },
                ranking: { title: "Classement", text: "victoires > différence > points marqués > rating. Pas de Buchholz." }
            },
            ...
            tirSystem: {
                ...
                structure: { title: "Structure", ateliers: "5 ateliers", distances: "6m, 7m, 8m, 9m (seniors) ou 6m, 7m, 8m (juniors)", maxSenior: "Max : 100 pts (senior)", maxJunior: "Max : 75 pts (junior)" },
                scoring: { title: "Pointage", carreau: "Carreau — 5 pts", reussi: "Réussi — 3 pts", touche: "Touché — 1 pt", manque: "Manqué — 0 pts" },
                modes: { title: "Modes", byParticipant: "Par participant", byAtelier: "Par atelier" },
                rounds: { title: "Qualification 2 tours", text: "Tour 1 pour tous, top 4 directement en quarts. Places 5-16 jouent tour 2. Top 4 du T2 rejoint les 4 directs." },
            ...
            playoffSystem: {
                ...
                seeding: { title: "Têtes de série", text: "Tableau standard : 1 et 2 se rencontrent en finale uniquement." },
                bracket: { title: "Tableau (8 équipes)", text: "1v8, 4v5, 3v6, 2v7 — les meilleurs se rencontrent le plus tard." },
                thirdPlace: { title: "Petite finale", text: "Match optionnel entre les perdants des demi-finales." },
                finalRanking: { title: "Classement final", first: "Vainqueur = 1er", second: "Finaliste = 2e", third: "Vainqueur petite finale = 3e", fourth: "Perdant petite finale = 4e", rest: "Quart-finalistes = 5e-8e" }
            },
            ...
            cadrageSystem: {
                ...
                example: { title: "Exemple : 50 équipes, top-16", direct: "Places 1-8 : directement qualifiées", cadrage: "Places 9-24 : jouent le cadrage", eliminated: "Places 25-50 : éliminées" },
                pairing: { title: "Appariement", text: "Meilleur vs pire : rang 9 vs 24, rang 10 vs 23, etc." },
                math: { title: "Calcul", directSeeds: "Qualifiés directs : top T/2", pool: "Pool cadrage : rangs T/2+1 à T×1.5", winners: "T/2 vainqueurs remplissent le tableau" }
            },
            ...
            swissPlayoff: {
                ...
                flow: { title: "Déroulement", step1: "Tours suisses (4-7)", step2: "Lancement du Playoff", step3: "Élimination directe" },
                options: { title: "Options", cadrage: "Ajouter un Cadrage", tournamentB: "Tournoi B pour les éliminés" }
            },
            ...
            swissBarragePlayoff: {
                ...
                flow: { title: "Déroulement", step1: "Tours suisses", step2: "Barrage en petits groupes", step3: "Vainqueurs en Playoff" },
            ...
            tournamentB: {
                ...
                howItWorks: { title: "Fonctionnement", step1: "Activer avant le playoff", step2: "Équipes non qualifiées copiées", step3: "Stats remises à zéro", step4: "Les deux tournois en parallèle" }
            },

            rankingAlgorithms: {
                title: "Algorithmes de classement",
                subtitle: "Comment les équipes sont triées",
                swiss: { title: "Suisse", criteria: "victoires > Buchholz > petit Buchholz > différence > points > rating" },
                groups: { title: "Poules", criteria: "victoires > victoires directes > points directs > différence", note: "Confrontations directes uniquement" },
                supermele: { title: "Supermêlée", criteria: "victoires > différence > points > rating", note: "Pas de Buchholz" },
                barrage: { title: "Barrage", criteria: "victoires > différence", note: "Résultats du barrage uniquement" },
                tir: { title: "TIR", criteria: "score total > carreaux", note: "Précision pure" },
                buchholz: { title: "Qu'est-ce que le Buchholz ?", text: "Somme des victoires de tous vos adversaires. Récompense les équipes ayant affronté des adversaires forts." },
                lanes: { title: "Attribution des terrains", text: "Minimise les répétitions via une matrice de poids." }
            },
    ...
    es: {
        docs: {
            ...
            glossary: {
                ...
                swiss: { term: "Sistema suizo", short: "Emparejamiento inteligente — rivales del mismo nivel, sin repeticiones" },
            ...
            swissSystem: {
                ...
                rules: { title: "Reglas", noRematch: "Un equipo NUNCA juega contra el mismo rival dos veces", equalWins: "Tras la ronda 1, equipos con mismas victorias se enfrentan", pairing: "Dentro del grupo: primero contra último", odd: "Número impar = Técnica para el más débil sin bye" },
                maxRounds: { title: "Rondas máximas", explanation: "Cada ronda elimina un rival posible. Tras ~N/2 rondas no hay pares válidos.", teams: "Equipos", rounds: "Rondas máx" },
                firstRound: { title: "Primera ronda", noRating: "Sin rating: aleatorio", withRating: "Con rating: cabezas de serie" },
                subsequentRounds: { title: "Rondas siguientes", step1: "Ordenar por ranking", step2: "Agrupar por victorias", step3: "Primero vs último", step4: "Si inválido: siguiente", step5: "Si ninguno: backtracking", step6: "Si agotado: error" },
                bye: { title: "Técnica (Bye)", text: "Número impar: el más débil recibe forfait (13:7). Máximo uno por torneo." },
                calculator: { title: "Calculadora suiza", description: "Calcula el número óptimo de rondas", teamsLabel: "Número de equipos", result: "Rondas recomendadas: {rounds} (máx: {max})" }
            },
            ...
            groupsSystem: {
                ...
                formation: { title: "Formación", withRating: "Con rating: distribución serpiente", noRating: "Sin rating: aleatorio", special: "Esquema especial para <33 equipos" },
                scheduling: { title: "Calendario", text: "Método circular: posición 0 fija, las demás rotan." },
                ranking: { title: "Clasificación", criteria: "victorias > directas > puntos directos > diferencia", headToHead: "En empate, solo cuentan los enfrentamientos directos." },
            ...
            barrageSystem: {
                ...
                withinSwiss: { title: "Dentro del suizo", step1: "Tras las rondas suizas, se lanza el barrage", step2: "Equipos en grupos pequeños (3-4)", step3: "Round-robin en cada grupo", step4: "Top N por grupo avanza" },
            ...
            supermeleSystem: {
                ...
                intro: "Jugadores individuales. Equipos reformados aleatoriamente cada ronda.",
                howItWorks: { title: "Cómo funciona", individual: "Jugadores individuales", shuffle: "Mezcla aleatoria en dobletes/tripletes", optimal: "Cálculo del mix óptimo", avoidRepeat: "Evita repeticiones" },
                math: { title: "Formación", text: "Mix ajustado para incluir a todos.", example: "Ej: 11 jugadores → 4 dobletes + 1 triplete = 11" },
                ranking: { title: "Ranking", text: "victorias > diferencia > puntos > rating. Sin Buchholz." }
            },
            ...
            tirSystem: {
                ...
                structure: { title: "Estructura", ateliers: "5 talleres", distances: "6m, 7m, 8m, 9m (seniors) o 6m, 7m, 8m (juniors)", maxSenior: "Máx: 100 pts (senior)", maxJunior: "Máx: 75 pts (junior)" },
                scoring: { title: "Puntuación", carreau: "Carreau — 5 pts", reussi: "Réussi — 3 pts", touche: "Touché — 1 pt", manque: "Manqué — 0 pts" },
                modes: { title: "Modos", byParticipant: "Por participante", byAtelier: "Por taller" },
                rounds: { title: "Clasificación 2 rondas", text: "Ronda 1 para todos, top 4 directo a cuartos. Puestos 5-16 juegan ronda 2." },
            ...
            playoffSystem: {
                ...
                finalRanking: { title: "Clasificación final", first: "Ganador = 1°", second: "Finalista = 2°", third: "Ganador 3° puesto = 3°", fourth: "Perdedor 3° puesto = 4°", rest: "Cuartofinalistas = 5°-8°" }
            },
            ...
            cadrageSystem: {
                ...
                example: { title: "Ejemplo: 50 equipos, top-16", direct: "Puestos 1-8: directos", cadrage: "Puestos 9-24: juegan cadrage", eliminated: "Puestos 25-50: eliminados" },
                pairing: { title: "Emparejamiento", text: "Mejor vs peor: puesto 9 vs 24, etc." },
                math: { title: "Cálculo", directSeeds: "Directos: top T/2", pool: "Pool: puestos T/2+1 a T×1.5", winners: "T/2 ganadores al cuadro" }
            },
            ...
            swissPlayoff: {
                ...
                flow: { title: "Flujo", step1: "Rondas suizas (4-7)", step2: "Lanzar Playoff", step3: "Eliminación directa" },
            ...
            swissBarragePlayoff: {
                ...
                flow: { title: "Flujo", step1: "Rondas suizas", step2: "Barrage en grupos", step3: "Ganadores al Playoff" },
            ...
            tournamentB: {
                ...
                howItWorks: { title: "Cómo funciona", step1: "Activar antes del playoff", step2: "Equipos copiados", step3: "Stats reseteadas", step4: "Ambos torneos en paralelo" }
            },

            rankingAlgorithms: {
                title: "Algoritmos de ranking",
                subtitle: "Cómo se ordenan los equipos",
                swiss: { title: "Suizo", criteria: "victorias > Buchholz > pequeño Buchholz > diferencia > puntos > rating" },
                groups: { title: "Grupos", criteria: "victorias > directas > puntos directos > diferencia", note: "Solo enfrentamientos directos" },
                supermele: { title: "Supermele", criteria: "victorias > diferencia > puntos > rating", note: "Sin Buchholz" },
                ...
                buchholz: { title: "¿Qué es Buchholz?", text: "Suma de victorias de todos tus rivales. Premia enfrentar rivales fuertes." },
