export default {
    en: {
        help: {
            ...
            drawResults2:
                'The lane number is displayed between teams. Lane assignments are random (except in playoffs).',
            drawResults3:
            ...
            stat: {
                title: 'Statistics',
                description:
                    'Allows you to count statistics in pétanque games and analyze data according to various criteria.',
                settings: {
                    title: 'Game Settings',
                    description:
    ...
    ua: {
        help: {
            ...
            shortText9:
                'Коли ви внесете результати фіналу, турнір буде завершено. Його можна заархівувати або видалити.',
            ...
            mainTabs1:
                'Команди: додавання та видалення команд до жеребкування першого раунду (або будь-коли для супермеле).',
            mainTabs2:
                'Поточні ігри: перегляд пар поточного раунду, внесення результатів та жеребкування наступних раундів.',
            ...
            stat: {
                title: 'Статистика',
                description:
                    'Дозволяє рахувати статистику в іграх з петанку та аналізувати дані по багатьом критеріям.',
                settings: {
                ...
                tags: {
                    title: 'Теги',
                    description:
                        'Теги - це ключові слова, якими можна описувати ігри. Можна створювати і видаляти теги.',
