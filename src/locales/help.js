export default {
    ...
    "ua": {
        "help": {
            ...
            "shortText7": "Увімкнути \"Плей-оф після швейцарських раундів\" у налаштуваннях турніру, вказати кількість команд у Налаштуваннях.",
            ...
            "tournamentControls2": "Після старту турніру з'являється кнопка \"Завершити турнір\". Натисніть її, щоб завершити турнір вручну. Турнір також завершується автоматично, коли внесені результати фіналу плей-оф.",
            ...
            "playOff": "Плей-оф",
            "playOffText": "Щоб увімкнути плей-оф, поставте галочку \"Плей-оф після швейцарських раундів\" у налаштуваннях турніру перед стартом. Кількість команд, що проходять далі, налаштовується у Налаштуваннях. Програма підтримує до 64 команд в олімпійській сітці.",
            "playOffText2": "Після початку плей-оф сітка доступна на вкладці \"Поточні ігри\" через кнопку \"Показати сітку плей-оф\". Якщо увімкнути \"Також грати Турнір Б\", автоматично створюється новий турнір для команд, що не пройшли у плей-оф.",
